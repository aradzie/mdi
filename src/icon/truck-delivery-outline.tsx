/* Generated from file truck-delivery-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TruckDeliveryOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TruckDeliveryOutline.displayName = "TruckDeliveryOutline";
