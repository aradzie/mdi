/* Generated from file chart-timeline-variant.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ChartTimelineVariant: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ChartTimelineVariant.displayName = "ChartTimelineVariant";
