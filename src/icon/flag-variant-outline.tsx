/* Generated from file flag-variant-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FlagVariantOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FlagVariantOutline.displayName = "FlagVariantOutline";
