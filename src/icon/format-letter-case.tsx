/* Generated from file format-letter-case.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FormatLetterCase: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FormatLetterCase.displayName = "FormatLetterCase";
