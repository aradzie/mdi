/* Generated from file comment-edit-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const CommentEditOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
CommentEditOutline.displayName = "CommentEditOutline";
