/* Generated from file account-card-details-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const AccountCardDetailsOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
AccountCardDetailsOutline.displayName = "AccountCardDetailsOutline";
