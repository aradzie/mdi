/* Generated from file filter-variant-remove.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FilterVariantRemove: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FilterVariantRemove.displayName = "FilterVariantRemove";
