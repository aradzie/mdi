/* Generated from file firework.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const Firework: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
        <path d="M5.8 16.59l-1.3-1.31 7.76-7.78 4.24 4.24-7.78 7.76-1.43-1.41c-.25.07-.49.19-.66.41-.06.07-.13.15-.13.24-.08.14-.12.26-.18.41-.11.27-.23.54-.39.78-.12.17-.25.33-.4.46-.11.11-.24.2-.37.27-.08.05-.16.1-.26.13-.6.25-1.27.21-1.9.21v-2h.9c.1 0 .18 0 .26-.06l.05-.05c.07-.08.13-.19.18-.29.08-.18.14-.36.21-.54l.04-.1c.12-.27.26-.51.44-.73.1-.13.22-.23.34-.36.12-.1.24-.2.38-.28M21 3l-1.12 8.19-7.07-7.07L21 3z"/>
    </SvgIcon>
);
