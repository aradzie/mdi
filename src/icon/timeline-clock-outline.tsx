/* Generated from file timeline-clock-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TimelineClockOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TimelineClockOutline.displayName = "TimelineClockOutline";
