/* Generated from file file-document-box-plus.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FileDocumentBoxPlus: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FileDocumentBoxPlus.displayName = "FileDocumentBoxPlus";

export default FileDocumentBoxPlus;
