/* Generated from file police-badge-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const PoliceBadgeOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
PoliceBadgeOutline.displayName = "PoliceBadgeOutline";
