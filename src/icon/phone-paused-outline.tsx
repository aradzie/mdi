/* Generated from file phone-paused-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const PhonePausedOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
PhonePausedOutline.displayName = "PhonePausedOutline";
