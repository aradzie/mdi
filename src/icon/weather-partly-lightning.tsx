/* Generated from file weather-partly-lightning.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const WeatherPartlyLightning: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
WeatherPartlyLightning.displayName = "WeatherPartlyLightning";
