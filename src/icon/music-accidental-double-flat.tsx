/* Generated from file music-accidental-double-flat.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const MusicAccidentalDoubleFlat: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
MusicAccidentalDoubleFlat.displayName = "MusicAccidentalDoubleFlat";
