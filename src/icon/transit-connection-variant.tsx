/* Generated from file transit-connection-variant.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TransitConnectionVariant: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TransitConnectionVariant.displayName = "TransitConnectionVariant";
