/* Generated from file cursor-default-click.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const CursorDefaultClick: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
CursorDefaultClick.displayName = "CursorDefaultClick";
