/* Generated from file truck-check-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TruckCheckOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TruckCheckOutline.displayName = "TruckCheckOutline";
