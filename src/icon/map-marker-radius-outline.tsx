/* Generated from file map-marker-radius-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const MapMarkerRadiusOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
MapMarkerRadiusOutline.displayName = "MapMarkerRadiusOutline";
