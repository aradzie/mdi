/* Generated from file message-text-lock-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const MessageTextLockOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
MessageTextLockOutline.displayName = "MessageTextLockOutline";
