/* Generated from file account-question-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const AccountQuestionOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
AccountQuestionOutline.displayName = "AccountQuestionOutline";
