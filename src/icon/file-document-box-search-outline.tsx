/* Generated from file file-document-box-search-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FileDocumentBoxSearchOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FileDocumentBoxSearchOutline.displayName = "FileDocumentBoxSearchOutline";
