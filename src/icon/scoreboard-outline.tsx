/* Generated from file scoreboard-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ScoreboardOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ScoreboardOutline.displayName = "ScoreboardOutline";
