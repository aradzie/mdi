/* Generated from file folder-information-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FolderInformationOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FolderInformationOutline.displayName = "FolderInformationOutline";
