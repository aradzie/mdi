/* Generated from file clipboard-text-multiple-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ClipboardTextMultipleOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ClipboardTextMultipleOutline.displayName = "ClipboardTextMultipleOutline";
