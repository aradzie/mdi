/* Generated from file speedometer-medium.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const SpeedometerMedium: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
SpeedometerMedium.displayName = "SpeedometerMedium";
