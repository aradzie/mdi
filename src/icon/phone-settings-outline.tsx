/* Generated from file phone-settings-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const PhoneSettingsOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
PhoneSettingsOutline.displayName = "PhoneSettingsOutline";
