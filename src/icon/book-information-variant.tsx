/* Generated from file book-information-variant.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const BookInformationVariant: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
BookInformationVariant.displayName = "BookInformationVariant";
