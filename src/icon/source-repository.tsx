/* Generated from file source-repository.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const SourceRepository: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
SourceRepository.displayName = "SourceRepository";
