/* Generated from file account-box-multiple-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const AccountBoxMultipleOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
AccountBoxMultipleOutline.displayName = "AccountBoxMultipleOutline";
