/* Generated from file hexagon-multiple-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const HexagonMultipleOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
HexagonMultipleOutline.displayName = "HexagonMultipleOutline";
