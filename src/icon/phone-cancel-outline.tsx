/* Generated from file phone-cancel-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const PhoneCancelOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
PhoneCancelOutline.displayName = "PhoneCancelOutline";
