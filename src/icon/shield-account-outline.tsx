/* Generated from file shield-account-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ShieldAccountOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ShieldAccountOutline.displayName = "ShieldAccountOutline";
