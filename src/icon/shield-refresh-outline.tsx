/* Generated from file shield-refresh-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ShieldRefreshOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ShieldRefreshOutline.displayName = "ShieldRefreshOutline";
