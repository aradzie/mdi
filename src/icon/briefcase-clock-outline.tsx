/* Generated from file briefcase-clock-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const BriefcaseClockOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
BriefcaseClockOutline.displayName = "BriefcaseClockOutline";
