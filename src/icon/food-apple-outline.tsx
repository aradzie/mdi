/* Generated from file food-apple-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FoodAppleOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FoodAppleOutline.displayName = "FoodAppleOutline";
