/* Generated from file thought-bubble-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ThoughtBubbleOutline: React.StatelessComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ThoughtBubbleOutline.displayName = "ThoughtBubbleOutline";
