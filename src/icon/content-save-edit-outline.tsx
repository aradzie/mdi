/* Generated from file content-save-edit-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ContentSaveEditOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ContentSaveEditOutline.displayName = "ContentSaveEditOutline";
