/* Generated from file file-document-edit.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FileDocumentEdit: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FileDocumentEdit.displayName = "FileDocumentEdit";
