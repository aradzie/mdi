/* Generated from file alarm-light-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const AlarmLightOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
AlarmLightOutline.displayName = "AlarmLightOutline";
