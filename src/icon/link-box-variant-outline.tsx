/* Generated from file link-box-variant-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const LinkBoxVariantOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
LinkBoxVariantOutline.displayName = "LinkBoxVariantOutline";
