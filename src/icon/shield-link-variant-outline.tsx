/* Generated from file shield-link-variant-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const ShieldLinkVariantOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
ShieldLinkVariantOutline.displayName = "ShieldLinkVariantOutline";
