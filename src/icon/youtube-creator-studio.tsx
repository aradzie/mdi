/* Generated from file youtube-creator-studio.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const YoutubeCreatorStudio: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
YoutubeCreatorStudio.displayName = "YoutubeCreatorStudio";

export default YoutubeCreatorStudio;
