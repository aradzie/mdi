/* Generated from file transit-connection.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TransitConnection: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TransitConnection.displayName = "TransitConnection";
