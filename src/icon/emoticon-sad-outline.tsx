/* Generated from file emoticon-sad-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const EmoticonSadOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
EmoticonSadOutline.displayName = "EmoticonSadOutline";
