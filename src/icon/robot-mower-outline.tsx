/* Generated from file robot-mower-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const RobotMowerOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
RobotMowerOutline.displayName = "RobotMowerOutline";
