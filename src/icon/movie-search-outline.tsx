/* Generated from file movie-search-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const MovieSearchOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
MovieSearchOutline.displayName = "MovieSearchOutline";
