/* Generated from file monitor-cellphone-star.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const MonitorCellphoneStar: React.StatelessComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
MonitorCellphoneStar.displayName = "MonitorCellphoneStar";
