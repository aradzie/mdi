/* Generated from file room-service-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const RoomServiceOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
RoomServiceOutline.displayName = "RoomServiceOutline";
