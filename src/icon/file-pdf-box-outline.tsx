/* Generated from file file-pdf-box-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FilePdfBoxOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
FilePdfBoxOutline.displayName = "FilePdfBoxOutline";
