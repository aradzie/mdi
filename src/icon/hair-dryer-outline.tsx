/* Generated from file hair-dryer-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const HairDryerOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
HairDryerOutline.displayName = "HairDryerOutline";
