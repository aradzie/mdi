/* Generated from file bed-double-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const BedDoubleOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
BedDoubleOutline.displayName = "BedDoubleOutline";
