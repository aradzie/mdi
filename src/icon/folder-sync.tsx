/* Generated from file folder-sync.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const FolderSync: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
        <path d="M10 4l2 2h8a2 2 0 012 2v3.5c-.77-.32-1.61-.5-2.5-.5a6.5 6.5 0 00-6.5 6.5c0 .89.18 1.73.5 2.5H4a2 2 0 01-2-2V6c0-1.11.89-2 2-2h6m9 8v1.5a4 4 0 014 4c0 .82-.25 1.58-.67 2.21l-1.09-1.09c.17-.34.26-.72.26-1.12A2.5 2.5 0 0019 15v1.5l-2.25-2.25L19 12m0 11v-1.5a4 4 0 01-4-4c0-.82.25-1.58.67-2.21l1.09 1.09c-.17.34-.26.72-.26 1.12A2.5 2.5 0 0019 20v-1.5l2.25 2.25L19 23z"/>
    </SvgIcon>
);
