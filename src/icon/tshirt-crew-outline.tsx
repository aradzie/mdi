/* Generated from file tshirt-crew-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const TshirtCrewOutline: React.StatelessComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
TshirtCrewOutline.displayName = "TshirtCrewOutline";
