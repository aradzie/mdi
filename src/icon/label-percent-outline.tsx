/* Generated from file label-percent-outline.svg. */

import { SvgIcon, SvgIconProps } from "../svg-icon";
import * as React from "react";

const LabelPercentOutline: React.FunctionComponent<SvgIconProps> = (props) => (
    <SvgIcon {...props}>
...
LabelPercentOutline.displayName = "LabelPercentOutline";
